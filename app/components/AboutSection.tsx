    ...
    return (
        <div className="overflow-hidden  w-screen h-screen">
            ...
            <section className="relative py-20 bg-white overflow-hidden">
                <div className="w-screen h-screen overflow-hidden mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 items-center">
                    {/* LEFT SIDE - Images */}
                    ...
                    <div className="relative">
                        ...
                        <p className="text-gray-600 mb-6">
                            We unite four technology-driven companies—Inspire Softech
                            Solutions, Edinz Tech, Adore Technology, and Igrean StarTech—to
                            shape future-ready talent and digital solutions.
                        </p>
